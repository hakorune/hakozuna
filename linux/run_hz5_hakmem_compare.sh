...
HZ5_PAGERUN64_LARGE_DRAINTRUST_OUT="${ROOT_DIR}/hakozuna-hz5/out/linux/x86_64-hz5-profile-large128-draintrust"
HZ5_PAGERUN64_LARGE_TRANSFER128_OUT="${ROOT_DIR}/hakozuna-hz5/out/linux/x86_64-hz5-profile-large128-transfer128"
HZ5_PAGERUN64_LARGE_TRANSFER128_TLSFIRST_OUT="${ROOT_DIR}/hakozuna-hz5/out/linux/x86_64-hz5-profile-large128-transfer128-tlsfirst"
HZ5_PAGERUN64_LARGE_TRANSFER128_OWNERSHARD_OUT="${ROOT_DIR}/hakozuna-hz5/out/linux/x86_64-hz5-profile-large128-transfer128-ownershard"
HZ5_PAGERUN64_LARGE_TRANSFER128_SHARD16_OUT="${ROOT_DIR}/hakozuna-hz5/out/linux/x86_64-hz5-profile-large128-transfer128-shard16"
...
Options:
  ...
  --allocators LIST    comma-separated allocators
                       ...
                       hz5-large128-transfer128,
                       hz5-large128-transfer128-tlsfirst,
                       hz5-large128-transfer128-ownershard,
                       hz5-large128-transfer128-shard16,
...
build_hz5() {
  ...
  if [[ ",${ALLOCATORS}," == *",hz5-large128-draintrust,"* ]]; then
    "${ROOT_DIR}/linux/build_linux_hz5_standalone.sh" \
      --linux-hz5-profile-large128-draintrust \
      --out-dir "${HZ5_PAGERUN64_LARGE_DRAINTRUST_OUT}" >/dev/null
  fi
  if [[ ",${ALLOCATORS}," == *",hz5-large128-transfer128,"* ]]; then
    "${ROOT_DIR}/linux/build_linux_hz5_standalone.sh" \
      --linux-hz5-profile-large128-transfer128 \
      --out-dir "${HZ5_PAGERUN64_LARGE_TRANSFER128_OUT}" >/dev/null
  fi
  if [[ ",${ALLOCATORS}," == *",hz5-large128-transfer128-tlsfirst,"* ]]; then
    "${ROOT_DIR}/linux/build_linux_hz5_standalone.sh" \
      --linux-hz5-profile-large128-transfer128-tlsfirst \
      --out-dir "${HZ5_PAGERUN64_LARGE_TRANSFER128_TLSFIRST_OUT}" >/dev/null
  fi
  if [[ ",${ALLOCATORS}," == *",hz5-large128-transfer128-ownershard,"* ]]; then
    "${ROOT_DIR}/linux/build_linux_hz5_standalone.sh" \
      --linux-hz5-profile-large128-transfer128-ownershard \
      --out-dir "${HZ5_PAGERUN64_LARGE_TRANSFER128_OWNERSHARD_OUT}" >/dev/null
  fi
  if [[ ",${ALLOCATORS}," == *",hz5-large128-transfer128-shard16,"* ]]; then
    "${ROOT_DIR}/linux/build_linux_hz5_standalone.sh" \
      --linux-hz5-profile-large128-transfer128-shard16 \
      --out-dir "${HZ5_PAGERUN64_LARGE_TRANSFER128_SHARD16_OUT}" >/dev/null
  fi
...
HZ5_PAGERUN64_LARGE_DRAINTRUST_SO="${HZ5_PAGERUN64_LARGE_DRAINTRUST_OUT}/libhakozuna_hz5_preload_full.so"
HZ5_PAGERUN64_LARGE_TRANSFER128_SO="${HZ5_PAGERUN64_LARGE_TRANSFER128_OUT}/libhakozuna_hz5_preload_full.so"
HZ5_PAGERUN64_LARGE_TRANSFER128_TLSFIRST_SO="${HZ5_PAGERUN64_LARGE_TRANSFER128_TLSFIRST_OUT}/libhakozuna_hz5_preload_full.so"
HZ5_PAGERUN64_LARGE_TRANSFER128_OWNERSHARD_SO="${HZ5_PAGERUN64_LARGE_TRANSFER128_OWNERSHARD_OUT}/libhakozuna_hz5_preload_full.so"
HZ5_PAGERUN64_LARGE_TRANSFER128_SHARD16_SO="${HZ5_PAGERUN64_LARGE_TRANSFER128_SHARD16_OUT}/libhakozuna_hz5_preload_full.so"
...
ALLOC_SO[hz5-large128-draintrust]="${HZ5_PAGERUN64_LARGE_DRAINTRUST_SO}"
ALLOC_SO[hz5-large128-transfer128]="${HZ5_PAGERUN64_LARGE_TRANSFER128_SO}"
ALLOC_SO[hz5-large128-transfer128-tlsfirst]="${HZ5_PAGERUN64_LARGE_TRANSFER128_TLSFIRST_SO}"
ALLOC_SO[hz5-large128-transfer128-ownershard]="${HZ5_PAGERUN64_LARGE_TRANSFER128_OWNERSHARD_SO}"
ALLOC_SO[hz5-large128-transfer128-shard16]="${HZ5_PAGERUN64_LARGE_TRANSFER128_SHARD16_SO}"
