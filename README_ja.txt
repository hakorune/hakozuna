...
HZ8 は HZ8 論文公開後に同じ Ubuntu-native table shape で固定された値を
追加しています。推奨 balanced line として読むべきで、万能 throughput winner
という意味ではありません。cross128_r90 は現在の弱点行として隠さず残しています。
...
- HZ8 採用 row: Ubuntu-native R10 HZ8 table の main_r0 / main_r50 /
  main_r90 / guard_r0 / cross128_r90。
- HZ8 cross128_r90 は既知の弱点行: 37.342k ops/s、post RSS 151.40 MiB、
