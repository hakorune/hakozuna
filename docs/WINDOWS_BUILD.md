...
- [`win/README.md`](../win/README.md): first-stop Windows entrypoint map
- [`docs/WINDOWS_PROFILE_BOUNDARIES.md`](WINDOWS_PROFILE_BOUNDARIES.md): shared profile vs Windows-only knob boundary

Windows-native comparisons and paper-aligned lanes are part of the public source release.

Windows build and benchmark lanes for `hz3` and `hz4` live under the repo-level [`win`](../win) entrypoints.
Those scripts forward to the maintained implementation under [`hakozuna/win`](../hakozuna/win),
...
- build and launch basics: [win/README.md](../win/README.md)
- Windows profile boundaries: [docs/WINDOWS_PROFILE_BOUNDARIES.md](WINDOWS_PROFILE_BOUNDARIES.md)
- public repo structure: [docs/REPO_STRUCTURE.md](REPO_STRUCTURE.md)
- benchmark summary layout: [docs/benchmarks/windows](benchmarks/windows)
...
- `hz4` uses a Windows-specific aligned allocation/release path in [hakozuna-mt/src/hz4_os.c](../hakozuna-mt/src/hz4_os.c) to avoid Linux-style partial `munmap()` assumptions on top of `VirtualAlloc`.
...
This reproduces the Windows section in [private/paper/RESULTS_20260118.md](../private/paper/RESULTS_20260118.md#L130) with:
...
section in [private/paper/RESULTS_20260118.md](../private/paper/RESULTS_20260118.md#L151) with:
...
section in [private/paper/RESULTS_20260118.md](../private/paper/RESULTS_20260118.md#L259) with:
...
section in [private/paper/RESULTS_20260118.md](../private/paper/RESULTS_20260118.md#L199) with:
...
- artifacts are built from [hakozuna/out_win_mt_remote_hz3](../hakozuna/out_win_mt_remote_hz3) and linked only into the MT remote bench
...
`workload_bench_system` lane in [private/paper/RESULTS_20260118.md](../private/paper/RESULTS_20260118.md#L86) with:
...
- the current quick end-to-end source-matrix summary is [docs/benchmarks/windows/apps/20260309_195356_redis_real_windows_matrix.md](../docs/benchmarks/windows/apps/20260309_195356_redis_real_windows_matrix.md)
- the richer profile-sweep summaries are:
  - [docs/benchmarks/windows/apps/20260310_145158_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_145158_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_145342_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_145342_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_145539_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_145539_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_154623_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_154623_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_154807_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_154807_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_160740_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_160740_redis_real_windows_profile_matrix.md)
  - [docs/benchmarks/windows/apps/20260310_161033_redis_real_windows_profile_matrix.md](../docs/benchmarks/windows/apps/20260310_161033_redis_real_windows_profile_matrix.md)
...
- [docs/WINDOWS_REDIS_MATRIX.md](../docs/WINDOWS_REDIS_MATRIX.md)
- [win/prepare_win_redis_private_layout.ps1](../win/prepare_win_redis_private_layout.ps1)
- [win/build_win_redis_source_variant.ps1](../win/build_win_redis_source_variant.ps1)
- [win/run_win_redis_real_matrix.ps1](../win/run_win_redis_real_matrix.ps1)
...
- the canonical private recovery layout is documented in [docs/WINDOWS_MEMCACHED_RECOVERY.md](../docs/WINDOWS_MEMCACHED_RECOVERY.md)
- the first dependency box is now documented in [docs/WINDOWS_MEMCACHED_LIBEVENT.md](../docs/WINDOWS_MEMCACHED_LIBEVENT.md)
- the preferred long-term path is now documented as a proper native MSVC lane in [docs/WINDOWS_MEMCACHED_MSVC_PLAN.md](../docs/WINDOWS_MEMCACHED_MSVC_PLAN.md)
- the current platform-shim boundary and probe results are documented in [docs/WINDOWS_MEMCACHED_SHIM.md](../docs/WINDOWS_MEMCACHED_SHIM.md)
- the current minimal Windows-native boot lane is documented in [docs/WINDOWS_MEMCACHED_MIN_MAIN.md](../docs/WINDOWS_MEMCACHED_MIN_MAIN.md)
...
- [docs/benchmarks/windows/apps/20260310_111947_558_memcached_external_client.md](../docs/benchmarks/windows/apps/20260310_111947_558_memcached_external_client.md)
- `10s / 4x16`
...
- the decisive Windows fix is in [memcached.c](../private/bench-assets/windows/memcached/source/memcached-1.6.40/memcached.c):
...
- companion verification reruns:
  - [docs/benchmarks/windows/apps/20260310_111845_985_memcached_external_client.md](../docs/benchmarks/windows/apps/20260310_111845_985_memcached_external_client.md)
    - `2s / 4x16`
    - `connection dropped.` count: `0`
    - server slot count: `64`
  - [docs/benchmarks/windows/apps/20260310_111921_025_memcached_external_client.md](../docs/benchmarks/windows/apps/20260310_111921_025_memcached_external_client.md)
    - `2s / 1x64`
    - `connection dropped.` count: `0`
    - server slot count: `64`
- latest profile sweep:
  - [docs/benchmarks/windows/apps/20260310_113133_memcached_external_client_matrix.md](../docs/benchmarks/windows/apps/20260310_113133_memcached_external_client_matrix.md)
...
- latest allocator comparison on the stable external-client lane:
  - [docs/benchmarks/windows/apps/20260310_123228_memcached_external_client_allocator_matrix.md](../docs/benchmarks/windows/apps/20260310_123228_memcached_external_client_allocator_matrix.md)
  ...
  - expanded `RUNS=3` profile compare:
    - [docs/benchmarks/windows/apps/20260310_132051_memcached_external_client_allocator_matrix.md](../docs/benchmarks/windows/apps/20260310_132051_memcached_external_client_allocator_matrix.md)
...
- earlier Windows-side hardening still remains in place:
  - Windows memcached socket-slot map updates are mutex-protected in [memcached.c](../private/bench-assets/windows/memcached/source/memcached-1.6.40/memcached.c)
  - Windows memtier socket setup initializes its keepalive / nodelay flag in [shard_connection.cpp](../private/bench-assets/windows/memcached/client/memtier_benchmark-2.2.1/shard_connection.cpp)
  - Windows memcached socket shims propagate `WSAENOBUFS -> EAGAIN` and related errno mappings in:
    - [win/memcached/include/sys/socket.h](../win/memcached/include/sys/socket.h)
    - [win/memcached/include/sys/uio.h](../win/memcached/include/sys/uio.h)
    - [win/memcached/include/unistd.h](../win/memcached/include/unistd.h)
...
- [docs/WINDOWS_MEMCACHED_RECOVERY.md](../docs/WINDOWS_MEMCACHED_RECOVERY.md)
- [docs/WINDOWS_MEMCACHED_LIBEVENT.md](../docs/WINDOWS_MEMCACHED_LIBEVENT.md)
- [docs/WINDOWS_MEMCACHED_MSVC_PLAN.md](../docs/WINDOWS_MEMCACHED_MSVC_PLAN.md)
- [docs/WINDOWS_MEMTIER_PROBE.md](../docs/WINDOWS_MEMTIER_PROBE.md)
- [docs/WINDOWS_MEMCACHED_SHIM.md](../docs/WINDOWS_MEMCACHED_SHIM.md)
- [docs/WINDOWS_MEMCACHED_MIN_MAIN.md](../docs/WINDOWS_MEMCACHED_MIN_MAIN.md)
- [win/prepare_win_memcached_private_layout.ps1](../win/prepare_win_memcached_private_layout.ps1)
- [win/prepare_win_memcached_libevent.ps1](../win/prepare_win_memcached_libevent.ps1)
- [win/probe_win_memcached_msvc.ps1](../win/probe_win_memcached_msvc.ps1)
- [win/build_win_memcached_min_main.ps1](../win/build_win_memcached_min_main.ps1)
- [win/run_win_memcached_min_smoke.ps1](../win/run_win_memcached_min_smoke.ps1)
- [win/run_win_memcached_min_throughput.ps1](../win/run_win_memcached_min_throughput.ps1)
- [win/run_win_memcached_min_matrix.ps1](../win/run_win_memcached_min_matrix.ps1)
- [win/run_win_memcached_min_mixed.ps1](../win/run_win_memcached_min_mixed.ps1)
- [win/run_win_memcached_benchmark_client.ps1](../win/run_win_memcached_benchmark_client.ps1)
- [win/run_win_memcached_benchmark_client_matrix.ps1](../win/run_win_memcached_benchmark_client_matrix.ps1)
- [win/run_win_memcached_external_client.ps1](../win/run_win_memcached_external_client.ps1)
- [win/run_win_memcached_external_client_matrix.ps1](../win/run_win_memcached_external_client_matrix.ps1)
- [win/probe_win_memtier_msvc.ps1](../win/probe_win_memtier_msvc.ps1)
- [win/run_win_memtier_probe_matrix.ps1](../win/run_win_memtier_probe_matrix.ps1)
