...
Generated: 2026-03-10 21:51:18 +09:00
...
Per-run detail:
- `balanced / hz4 / set`: [1,282,051.25, 1,315,789.50, 1,351,351.38]
- `balanced / hz4 / get`: [1,408,450.62, 1,492,537.25, 1,449,275.38]
- `balanced / hz4 / lpush`: [1,098,901.12, 1,149,425.38, 1,176,470.62]
- `balanced / hz4 / lpop`: [1,149,425.38, 1,190,476.25, 1,219,512.12]

Artifacts: [out_win_redis_real](/C:/git/hakozuna-win/out_win_redis_real)
Raw log: `C:\git\hakozuna-win\private\raw-results\windows\redis\real_profile_matrix\20260310_215118_redis_real_windows_profile_matrix.log`
