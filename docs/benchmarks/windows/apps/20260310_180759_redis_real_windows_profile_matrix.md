...
Generated: 2026-03-10 18:07:59 +09:00
...
| balanced | hz4 | get | 1,449,275.38 | 50 | 16 | 100000 | 3 |
| balanced | hz4 | lpush | 1,162,790.62 | 50 | 16 | 100000 | 3 |
| balanced | hz4 | lpop | 1,219,512.12 | 50 | 16 | 100000 | 3 |

Per-run detail:
- `balanced / hz4 / set`: [1,333,333.25, 1,333,333.25, 1,351,351.38]
- `balanced / hz4 / get`: [1,428,571.38, 1,388,889.00, 1,449,275.38]
- `balanced / hz4 / lpush`: [1,086,956.50, 1,149,425.38, 1,162,790.62]
- `balanced / hz4 / lpop`: [1,162,790.62, 1,219,512.12, 1,219,512.12]

Artifacts: [out_win_redis_real](/C:/git/hakozuna-win/out_win_redis_real)
Raw log: `C:\git\hakozuna-win\private\raw-results\windows\redis\real_profile_matrix\20260310_180759_redis_real_windows_profile_matrix.log`
