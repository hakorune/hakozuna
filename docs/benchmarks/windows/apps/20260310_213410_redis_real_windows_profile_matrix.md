...
Generated: 2026-03-10 21:34:10 +09:00
...
Per-run detail:
- `balanced / hz4 / set`: [1,388,889.00, 1,265,822.75, 1,298,701.25]
- `balanced / hz4 / get`: [1,408,450.62, 1,428,571.38, 1,492,537.25]
- `balanced / hz4 / lpush`: [1,136,363.62, 1,149,425.38, 1,149,425.38]
- `balanced / hz4 / lpop`: [1,204,819.38, 1,219,512.12, 1,219,512.12]

Artifacts: [out_win_redis_real](/C:/git/hakozuna-win/out_win_redis_real)
Raw log: `C:\git\hakozuna-win\private\raw-results\windows\redis\real_profile_matrix\20260310_213410_redis_real_windows_profile_matrix.log`
