...
## Follow-up Result Log

```text
Later observe verification, synchronized sweeps, guarded free-batch consume,
p32 clean preset, malloc-large, and segment-registry follow-up logs moved to:
  2026-03-19_MAC_BENCH_RESULTS_FOLLOWUP.md
```
