...
- HZ8 remains the public recommended balanced line: lowest HZ post RSS in this
  integrated matrix.
- HZ10 is the speed-oriented research candidate. Its bump-init default now
  closes the HZ8 local-throughput gap while keeping local-row RSS low, but
  remote/interleaved rows still retain tens of MiB.
