...
`hz7/v1/` tree stays frozen as the cute v1 baseline; this folder is where
...
```powershell
powershell -ExecutionPolicy Bypass -File .\hz7/v2\win\build_win_hz7_smokes.ps1
```
...
```powershell
powershell -ExecutionPolicy Bypass -File .\hz7/v2\win\run_win_hz7_v2_size_slices.ps1 -Runs 3
```
...
```powershell
powershell -ExecutionPolicy Bypass -File .\hz7/v2\win\run_win_hz7_v2_hotpath.ps1 -Runs 3
```
