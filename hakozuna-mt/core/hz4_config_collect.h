...
#endif
#ifndef HZ4_MID_FREE_BATCH_CONSUME_SC_MAX
#define HZ4_MID_FREE_BATCH_CONSUME_SC_MAX ((HZ4_PAGE_SIZE / HZ4_MID_ALIGN) - 1)
#endif
#ifndef HZ4_MID_FREE_BATCH_CONSUME_SC_MIN
#define HZ4_MID_FREE_BATCH_CONSUME_SC_MIN 0
#endif
#if HZ4_MID_FREE_BATCH_CONSUME_BOX && \
    (HZ4_MID_FREE_BATCH_CONSUME_SC_MIN >= (HZ4_PAGE_SIZE / HZ4_MID_ALIGN))
#error "HZ4_MID_FREE_BATCH_CONSUME_SC_MIN out of mid size-class range"
#endif
#if HZ4_MID_FREE_BATCH_CONSUME_BOX && \
    (HZ4_MID_FREE_BATCH_CONSUME_SC_MAX >= (HZ4_PAGE_SIZE / HZ4_MID_ALIGN))
#error "HZ4_MID_FREE_BATCH_CONSUME_SC_MAX out of mid size-class range"
#endif
#if HZ4_MID_FREE_BATCH_CONSUME_BOX && \
    (HZ4_MID_FREE_BATCH_CONSUME_SC_MIN > HZ4_MID_FREE_BATCH_CONSUME_SC_MAX)
#error "HZ4_MID_FREE_BATCH_CONSUME_SC_MIN must be <= HZ4_MID_FREE_BATCH_CONSUME_SC_MAX"
#endif
...
#define HZ4_MID_PAGE_SUPPLY_RESV_CHUNK_PAGES 16
#endif
