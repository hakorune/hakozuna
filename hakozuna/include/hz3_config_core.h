...
// TLS init observability (debug-only, one log per thread)
#ifndef HZ3_TLS_INIT_LOG
#define HZ3_TLS_INIT_LOG 0
#endif

// One-shot malloc entry log (debug-only; avoid hot-path atomics)
#ifndef HZ3_MALLOC_FIRST_LOG
#define HZ3_MALLOC_FIRST_LOG 0
#endif

// Fail-fast if multiple threads appear to share the same TLS address
#ifndef HZ3_TLS_INIT_FAILFAST
#define HZ3_TLS_INIT_FAILFAST 0
#endif
...
// Arena alloc fail diagnostics (debug-only, one-shot)
#ifndef HZ3_ARENA_ALLOC_FAIL_SHOT
#define HZ3_ARENA_ALLOC_FAIL_SHOT 0
#endif

#ifndef HZ3_ARENA_ALLOC_FAIL_MAX
