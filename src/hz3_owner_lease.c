...
static __thread uint8_t g_owner_lease_depth[HZ3_NUM_SHARDS];
static __thread uint32_t g_owner_lease_start_us[HZ3_NUM_SHARDS];
static __thread uintptr_t g_owner_lease_start_ra[HZ3_NUM_SHARDS];
