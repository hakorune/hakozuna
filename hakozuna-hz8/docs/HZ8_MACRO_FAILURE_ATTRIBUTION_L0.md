...
F4 (xmalloc) bound/backoff the sched_yield spin in owner-lifecycle/remote-free
             (or switch to a futex under sustained contention) so it cannot
             livelock. Needs the exact yield loop located first.
