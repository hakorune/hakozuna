...
|---|---|---|---|
| `hz8` / `hz8-general-medium-entry` | `preload` | public default | SmallTransitionInventory + GeneralMediumPage + EntryBoundary-L1A + MediumTransitionInventory |
| `hz8-medium-transition-inventory` | `preload-medium-transition-inventory` | compatibility alias | Same behavior as the promoted public default |
...
| Lane | Build target | Status | Purpose |
|---|---|---|---|
| `hz8-v2-rollback` | `preload-v2-rollback` | deep rollback | Previous KeepRefill + span-lease + Mag16 public behavior |
| `hz8-small-transition-inventory` | `preload-small-transition-inventory` | immediate rollback | Previous public default before MediumTransitionInventory promotion |
| `hz8-pre-transition-rollback` | `preload-pre-transition-rollback` | deeper rollback | GeneralMedium default before SmallTransitionInventory promotion |
