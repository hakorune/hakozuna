...
Current direction:
  ...
  HZ10LocalPageSubstrate in hakozuna-hz10/: Box1 pagemap route + Box2
                freelist page done (uncommitted), Box3 RemoteStackDrain
                next. First GO >=2x HZ8 or 250M+ local0, not tcmalloc-70%.
