...
Current direction:
  ...
  HZ10LocalPageSubstrate in hakozuna-hz10/: Box1-3 (pagemap route,
                freelist page, remote stack drain) done (uncommitted),
                Box4 BoundedPagePool next. First GO >=2x HZ8 or 250M+
                local0, not tcmalloc-70%.
