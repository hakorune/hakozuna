...
// ============================================================================
// S55-3B: Epoch counter (public for delayed purge)
// ============================================================================

// Get current global epoch counter (atomic, shared across all threads)
// - Used by S55-3B for delayed purge queue stamping and age checks
// - Returns: current epoch value (monotonically increasing in L2)
