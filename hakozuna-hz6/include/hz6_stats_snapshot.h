...
typedef struct Hz6StatsSnapshot {
  ...
  size_t free_resolve_attempt;
  size_t free_resolve_shared_probe;
  size_t free_resolve_shared_valid;
  size_t free_resolve_shared_miss;
  size_t free_resolve_shared_retry;
  size_t free_resolve_shared_stale;
  size_t free_resolve_local_lookup;
  size_t free_resolve_visible_shadow;
  size_t free_resolve_visible_hit;
  size_t free_resolve_result_local_valid;
  size_t free_resolve_result_foreign_valid;
  size_t free_resolve_result_owned_invalid;
  size_t free_resolve_result_proven_external;
  size_t free_resolve_result_retry;
  size_t free_resolve_result_unresolved_integrity;
  ...
  size_t shared_dir_tombstone_current;
  size_t shared_dir_tombstone_max;
  size_t shared_dir_register_used_tombstone;
  size_t shared_dir_maintenance_attempt;
  size_t shared_dir_maintenance_success;
  size_t shared_dir_maintenance_cleared;
  ...
  size_t toy_class4_malloc_fast_attempt;
  size_t toy_class4_malloc_fast_hit;
  size_t toy_class4_malloc_front_dispatch;
  size_t toy_class4_malloc_frontcache_pop;
  size_t toy_class4_malloc_activate_success;
  size_t toy_small_free_cache_attempt;
  size_t toy_small_free_cache_success;
  size_t toy_class4_free_cache_attempt;
  size_t toy_class4_free_cache_success;
  size_t toy_small_active_map_register;
  size_t toy_small_active_map_register_collision;
  size_t toy_class4_active_map_register;
  ...
  size_t midpage_active_map_free_cache_attempt;
  size_t midpage_active_map_free_cache_success;
  ...
  size_t memory_midpage_32k_active_descriptors;
  size_t memory_midpage_8k_local_free_descriptors;
  size_t memory_midpage_32k_local_free_descriptors;
  size_t memory_midpage_8k_transfer_free_descriptors;
  size_t memory_midpage_32k_transfer_free_descriptors;
  size_t memory_midpage_8k_remote_pending_descriptors;
  size_t memory_midpage_32k_remote_pending_descriptors;
  size_t memory_midpage_8k_all_local_free_blocks;
  size_t memory_midpage_32k_all_local_free_blocks;
  size_t memory_midpage_8k_all_local_free_payload_bytes;
  size_t memory_midpage_32k_all_local_free_payload_bytes;
  size_t memory_midpage_8k_active_zero_local_free_nonzero_blocks;
  size_t memory_midpage_32k_active_zero_local_free_nonzero_blocks;
  size_t memory_midpage_8k_low_active_1_4_blocks;
  size_t memory_midpage_32k_low_active_1_4_blocks;
  size_t memory_midpage_8k_low_active_1_4_payload_bytes;
  size_t memory_midpage_32k_low_active_1_4_payload_bytes;
  size_t memory_midpage_ref_mismatch_blocks;
  size_t memory_midpage_8k_retire_candidate_blocks;
  size_t memory_midpage_32k_retire_candidate_blocks;
  size_t memory_midpage_8k_retire_candidate_payload_bytes;
  size_t memory_midpage_32k_retire_candidate_payload_bytes;
  size_t memory_midpage_8k_retire_candidate_descriptors;
  ...
  size_t midpage_32k_cold_purge_attempt;
  size_t midpage_32k_cold_purge_scan_blocks;
  size_t midpage_32k_cold_purge_candidate_blocks;
  size_t midpage_32k_cold_purge_purged_blocks;
  size_t midpage_32k_cold_purge_purged_bytes;
  size_t midpage_32k_cold_purge_fail;
  size_t midpage_32k_cold_purge_blocked;
  size_t midpage_32k_cold_purge_recommit;
  size_t midpage_32k_cold_purge_recommit_fail;
