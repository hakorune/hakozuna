...
| `hz6-small-boundary-trusted-toy-map8192-external-target` | `build_hz6_preload_small_boundary_trusted_toy_map8192_external_target.sh` | Lower-RSS fixed-boundary profile; repeat-9 fixed rows improve, mixed-small rows remain weak. |
