...
| `hz6-cross128-toy2-route-before-maps-target` | `build_hz6_preload_cross128_toy2_route_before_maps_target.sh` | Explicit cross128 free-dispatch candidate; toy2 split plus TLS-armed foreign route-before-maps. R10 lifted cross128 while holding local0/remote50, but remote90 stayed slightly lower. |
