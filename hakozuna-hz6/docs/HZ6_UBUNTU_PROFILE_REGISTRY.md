...
| `hz6-workload-descriptor-hybrid-target` | `build_hz6_preload_workload_descriptor_hybrid_target.sh` | Workload speed/RSS hybrid control; route40K/descriptors10K/source1280 plus 2048-slot elastic descriptor depot. |
