...
| Larson T16 full 10k lowest RSS | `speed + ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-source16k-route192k-run512` | 47.616M | 456,048 | clean selected sibling candidate |
...
| Larson RoutePackedMeta L2 routebytes16 | `ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-source16k-route192k-run512` | Candidate-control, not selected yet. Raw uint16 route bytes overflow only on 64KiB envelopes (`route_bytes16_overflow=147`, `route_bytes16_max=65536`), while biased `uint16_t(bytes - 1)` is clean (`minus1_overflow=0`, `minus1_zero=0`). Same-run full-10k A/B, runs=1: routepacked `44.140M / 456040 KB`, routebytes16 `44.392M / 449132 KB`, safety clean. Needs repeat-3 before replacing RoutePackedMeta L1. |
