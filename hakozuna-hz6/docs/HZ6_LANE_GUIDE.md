...
| Candidate-control | `largedirectretain16m-largerlowrss-front8k-sourcerun-desc8k-route8k` / legacy `hz6-*-largedirectretain16m-largerlowrss` | Practical LargeDirectRetain cap after the repeat-3 cap ladder. 16M removes source churn for 2M/4M/8M while keeping 512K/1M guard source counts unchanged. Use this for the next cross-allocator `large_slices` refresh. |
