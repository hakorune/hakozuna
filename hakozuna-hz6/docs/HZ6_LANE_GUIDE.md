...
| Ubuntu LD_PRELOAD default bundle | `build_hz6_preload.sh` default flags | Canonical preload lane: route65k, desc16384, source2048, frontcache4096, Toy active map32768, MidPage run768K, MidPage 32K run768K, external MidPage active map16K/probe4 with unaligned slots allowed, MidPage alloc descriptor-out, preload-boundary MidPage malloc skip, current-bias free order, realloc in-place, mmap retain, 64K retain stack, ToyFull max128, tombstone compact, xor-fold, linear-wrap, loop-carry. |
