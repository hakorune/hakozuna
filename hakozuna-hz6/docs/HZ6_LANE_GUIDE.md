...
| Preset/control | `win/run_win_hz6_selected_family.ps1 -LargeDirectRetainControl` | Convenience preset for the LargeDirectRetain lane. It compares LargerLowRSS base vs retain32m on 2M/4M/8M direct slices and includes 512K/1M LargeSpan guards. This preset is intentionally outside `-SelectedFamily`. |
