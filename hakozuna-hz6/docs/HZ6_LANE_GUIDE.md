...
| Ubuntu closeout | `MidPageHz4Close-L1` | Closed as the current LD_PRELOAD MidPage selected result. MidPage unaligned active-map plus probe4 moved `4096..16384` to `hz6 31.505M / 117,248 KB` versus `hz4 30.916M / 134,400 KB`. Follow-up active-map capacity/probe/code-shape tuning produced no selected change. |
