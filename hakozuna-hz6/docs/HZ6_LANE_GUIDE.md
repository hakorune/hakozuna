...
| Ubuntu diagnostic-only | `HZ6_PRELOAD_STATS=1` | Prints one aggregate `[HZ6_PRELOAD_STATS]` line at process unload across registered thread-local preload allocators. Use to attribute source/route/fail pressure; do not use for speed ranking. |
