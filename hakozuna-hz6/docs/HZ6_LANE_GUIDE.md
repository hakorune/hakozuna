...
| Ubuntu control | `HZ6_FRONT_CACHE_BIN_CAPACITY=8192` in LD_PRELOAD | Former wide preload default. StaticTableTrim-L1 promoted frontcache4096 with desc16384/source2048, and FixedFloorRoute32K-L1 later promoted route32K, cutting the fixed table floor while preserving or improving selected rows. Keep 8192 as a wide-table control. |
