...
| Ubuntu control | `HZ6_FRONT_CACHE_BIN_CAPACITY=8192` in LD_PRELOAD | Former wide preload default. StaticTableTrim-L1 promoted frontcache4096, FixedFloorRoute32K-L1 promoted route32K, and the latest fixed-floor trim promotes desc8192/source1024. Keep 8192 and `floor_prev` as direct controls. |
