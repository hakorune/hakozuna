...
| Ubuntu profile/control DSO | `build_hz6_preload_toy_target.sh` | Named Toy/mid-small DSO. It builds selected preload plus `HZ6_PRELOAD_TOY_MALLOC_DIRECT_CLASS_L1=1,max4096`, preserving selected default while exposing the mid-small win for workloads that do not need MidPage/fixed guard balance. Repeat-7 raw `hz6_midpage_payload_trim_ab_20260615_220021` improved 16..256, 16..4096, 1024..4096, and fixed_4k, but regressed the MidPage target and fixed_8k/16k guards. |
