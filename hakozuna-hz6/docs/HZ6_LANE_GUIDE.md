...
| Ubuntu LD_PRELOAD default bundle | `build_hz6_preload.sh` default flags | Canonical preload lane: route65k, desc16384, source2048, frontcache4096, Toy active map32768, MidPage run768K, MidPage 32K run1536K, external MidPage active map16K/probe4 with unaligned slots allowed, MidPage alloc descriptor-out, preload-boundary MidPage malloc skip, current-bias free order, realloc in-place, mmap retain, 64K retain stack, ToyFull max128, tombstone compact, xor-fold, linear-wrap, loop-carry. |
...
| Ubuntu selected/default | `HZ6_MIDPAGE_32K_RUN_BYTES=1572864` in LD_PRELOAD | MidPage32KRun1536-L1. After run768, a larger 32K run cut source churn and improved the 4096..16384 target: focused repeat-15 moved `46.078M -> 47.991M`, with `16..256`, `16..4096`, and `1024..4096` costs all under 1%. Stats repeat-3 kept fail counters 0 and cut 4096..16384 source_alloc `1599 -> 900`. Keep 768K and 512K as direct controls. |
