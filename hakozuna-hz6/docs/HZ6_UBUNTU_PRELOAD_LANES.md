...
| Next lane | design/diagnostic | frontcache storage trim v2 and 32K run fine ladder are closed; next pick should target payload release/reuse behavior or a no-branch free-hit shape |
