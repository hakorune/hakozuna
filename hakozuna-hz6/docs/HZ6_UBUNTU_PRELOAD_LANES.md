...
| Small-boundary trusted Toy-map8192 external target DSO | lower-RSS fixed-boundary profile/control, no default | Added runner variants `small_boundary_trusted_toy_map8192_external`, `small_boundary_trusted_toy_map8192_frontcache_packed`, and `small_boundary_trusted_toy_map8192_external_frontcache_packed` to test whether the fixed-boundary RSS profile should absorb Toy external active-map storage or packed frontcache metadata. Production repeat-5/no-stats raw `hz6_midpage_payload_trim_ab_20260616_071900` showed the RSS direction was real, and thicker repeat-9/no-stats raw `hz6_midpage_payload_trim_ab_20260616_072333` promoted `external` to a persistent explicit profile: versus `small_boundary_trusted_toy_map8192`, `external` improves `fixed_4k 35.723M / 78.88 MiB -> 36.403M / 77.75 MiB`, `fixed_8k 34.605M / 79.12 MiB -> 34.860M / 78.25 MiB`, `fixed_16k 34.857M / 79.25 MiB -> 35.055M / 78.12 MiB`, and target `4096..16384 35.728M / 80.00 MiB -> 35.831M / 79.00 MiB`. Mixed-small remains weak (`16..4096` and `1024..4096` regress), so keep out of selected/default and out of standard frontier. `frontcache_packed` and external+packed remain runner-only controls because their speed is less balanced. Persistent alias: `hz6-small-boundary-trusted-toy-map8192-external-target` / `hz6_small_boundary_trusted_toy_map8192_external_target`. |
