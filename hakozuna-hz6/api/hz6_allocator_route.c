...
static void hz6_allocator_route_last_hit_clear(Hz6Allocator* allocator) {
  if (!allocator) {
    return;
  }
...
static Hz6RouteResult hz6_allocator_route_last_hit_lookup(
...
static void hz6_allocator_route_last_hit_fill(Hz6Allocator* allocator,
                                              void* base,
                                              uint16_t front_id,
                                              uint16_t class_id,
                                              uint32_t generation,
...
static void hz6_allocator_route_last_hit_fill_route(Hz6Allocator* allocator,
                                                    const void* ptr,
                                                    Hz6RouteResult route) {
