...
HZ6_PRELOAD_DEFAULT_CFLAGS="${HZ6_PRELOAD_DEFAULT_CFLAGS:--DHZ6_ROUTE_TABLE_CAPACITY=131072 -DHZ6_OBJECT_DESCRIPTOR_CAPACITY=32768 -DHZ6_SOURCE_BLOCK_CAPACITY=4096 -DHZ6_FRONT_CACHE_BIN_CAPACITY=8192 -DHZ6_TOY_SMALL_ACTIVE_FREE_MAP_CAPACITY=32768 -DHZ6_MIDPAGE_RUN_BYTES=262144 -DHZ6_MIDPAGE_ACTIVE_FREE_MAP_L2=1 -DHZ6_MIDPAGE_ACTIVE_FREE_MAP_EXTERNAL_L2=1 -DHZ6_LINUX_MMAP_RETAIN_L1=1 -DHZ6_LINUX_MMAP_RETAIN_64K_STACK_L1=1 -DHZ6_TOY_FULL_BLOCK_PREFILL_L1=1 -DHZ6_TOY_FULL_BLOCK_PREFILL_MAX_SLOTS=128 -DHZ6_ROUTE_TOMBSTONE_COMPACT_L1=1 -DHZ6_ROUTE_HASH_XOR_FOLD_L1=1 -DHZ6_ROUTE_LINEAR_WRAP_L1=1 -DHZ6_ROUTE_LOOP_CARRY_L1=1}"
