...
HZ6_PRELOAD_DEFAULT_CFLAGS="${HZ6_PRELOAD_DEFAULT_CFLAGS:--DHZ6_ROUTE_TABLE_CAPACITY=32768 -DHZ6_OBJECT_DESCRIPTOR_CAPACITY=32768 -DHZ6_SOURCE_BLOCK_CAPACITY=4096 -DHZ6_FRONT_CACHE_BIN_CAPACITY=1024 -DHZ6_TOY_SMALL_ACTIVE_FREE_MAP_CAPACITY=32768 -DHZ6_ROUTE_HASH_XOR_FOLD_L1=1 -DHZ6_ROUTE_LINEAR_WRAP_L1=1 -DHZ6_ROUTE_LOOP_CARRY_L1=1}"
