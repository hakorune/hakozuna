...
hz6_preload_effective_selected_cflags HZ6_REALLOC_BOUNDARY_8K_TARGET_CFLAGS 1
hz6_preload_replace_define HZ6_REALLOC_BOUNDARY_8K_TARGET_CFLAGS \
  HZ6_PRELOAD_REALLOC_BOUNDARY_SLACK_8K_L1 1

OUT_DIR="${OUT_DIR:-${ROOT_DIR}/hakozuna-hz6/out/linux/hz6_preload_realloc_boundary_8k_target}" \
