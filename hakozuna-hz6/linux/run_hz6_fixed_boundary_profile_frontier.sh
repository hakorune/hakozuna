...
ALLOCATORS="${ALLOCATORS:-hz6,hz6-small-boundary-trusted-target,hz6-realloc-boundary-4k-target,hz6-realloc-boundary-8k-target,hz6-realloc-boundary-adaptive-4k-target,hz6-realloc-boundary-adaptive-8k-target,hz6-realloc-boundary-adaptive-target,hz6-toy-trusted-target}"
...
against small-boundary trusted, split realloc-boundary, and adaptive
realloc-boundary profile DSOs without changing selected/default flags.
EOF
}
