...
HZ6_CROSS128_TOY2_ROUTE_BEFORE_MAPS_CFLAGS=()
hz6_preload_profile_owner_inbox_toy2_route_before_maps_cflags \
  HZ6_CROSS128_TOY2_ROUTE_BEFORE_MAPS_CFLAGS 1

hz6_preload_profile_build \
  HZ6_CROSS128_TOY2_ROUTE_BEFORE_MAPS_CFLAGS \
  "${ROOT_DIR}/hakozuna-hz6/out/linux/hz6_preload_cross128_toy2_route_before_maps"
