...
require_zero "remote_pending_external_ticket_duplicate_index_stale"
...
require_zero "remote_pending_destroy_external_release_fail"
require_zero "remote_pending_enqueue_after_owner_dying"
require_zero "remote_pending_ticket_to_dead_owner"
require_zero "remote_pending_ticket_to_dead_storage_owner"
require_zero "remote_pending_route_removed_while_pending"
require_zero "remote_pending_after_allocator_destroy"
