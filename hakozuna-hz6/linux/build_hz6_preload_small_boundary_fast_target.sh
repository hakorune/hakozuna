...
hz6_preload_effective_selected_cflags HZ6_SMALL_BOUNDARY_FAST_TARGET_CFLAGS 1
...
OUT_DIR="${OUT_DIR:-${ROOT_DIR}/hakozuna-hz6/out/linux/hz6_preload_small_boundary_fast_target}" \
