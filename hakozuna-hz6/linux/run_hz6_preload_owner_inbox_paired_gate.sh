...
Options:
  ...
  --variants CSV p0_selected_off,p1_owner_inbox,p0_transfer_class_presence,p0_transfer_class_presence_min192
...
for variant in "${raw_variants[@]}"; do
  case "$variant" in
    p0_selected_off|p1_owner_inbox|p0_transfer_class_presence|p0_transfer_class_presence_min192)
      variants+=("$variant")
      ;;
    "") ;;
