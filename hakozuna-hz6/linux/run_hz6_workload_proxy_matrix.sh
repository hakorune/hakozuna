...
RUNS="${RUNS:-3}"
ITERS="${ITERS:-200000}"
ALLOCATORS="${ALLOCATORS:-system,hz3,hz4,hz6,hz6-workload-capacity-target,hz6-small-boundary-trusted-toy-map8192-target,hz6-small-boundary-trusted-toy-map8192-external-target,mimalloc,tcmalloc}"
