...
HZ6_PRELOAD_SELECTED_BASE_CFLAGS=(
  ...
  -DHZ6_REMOTE_FREE_BACKPRESSURE_ORIGIN_TRANSFER_STRIDE=1
  ...
  -DHZ6_PRELOAD_MALLOC_TRANSFER_RETRY_L1=0
  ...
  -DHZ6_REMOTE_FREE_BACKPRESSURE_ORIGIN_DRAIN_L1=0
  -DHZ6_REMOTE_PENDING_INBOX_CORE_L1=0
  -DHZ6_REMOTE_FREE_BACKPRESSURE_OWNER_INBOX_L1=0
  -DHZ6_REMOTE_PENDING_OWNER_LOCAL_MAINTENANCE_L1=0
