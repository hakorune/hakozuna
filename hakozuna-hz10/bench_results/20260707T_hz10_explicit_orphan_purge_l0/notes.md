...
The explicit purge API is functional and should be kept as the correct quiescent boundary. Interpret RSS deltas with care: this A/B uses a temporary dlsym-patched HZ8 harness copy and should be promoted to a proper lane before default/product claims.
