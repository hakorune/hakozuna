...
$presetMap = [ordered]@{
    ...
    "larson-cross-owner-lowest-rss" = New-Preset `
        ...
        -BenchmarkProfiles @("larson_t16_main_10k") `
        -Hz6Profiles @("speed") `
        -CapacityLanes @("ownerlocalityfast-rsscap-2-desc160k-front4k", "ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-source16k-route192k", "ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-nobackptr-source16k-route192k-run512", "ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-nobackptr-dir192k-source16k-route192k-run512", "ownerlocalityfast-rsscap-2-desc160k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-source16k-route192k-run512") `
        -Note "front4k versus route192k, no-backptr, selected dir192k, and source-block no-route-backptr lowest-RSS Larson siblings"
