...
$presetMap = [ordered]@{
    ...
    "larson-cross-owner-selected" = New-Preset `
        ...
        -Note "Larson full 10k selected lane plus OwnerSourceSideMeta-L2 lowest-RSS sibling, FrontCachePackedMeta-L1, and SourceBlockPackedFlags-L1 lower-RSS candidates"
    ...
    "larson-cross-owner-lowest-rss" = New-Preset `
        ...
        -Note "front4k versus route192k, no-backptr, dir192k/source-block controls, routepacked, routebytes16 control, storageowner16 evidence, OwnerSourceSideMeta-L2 selected sibling, FrontCachePackedMeta-L1, and SourceBlockPackedFlags-L1 lower-RSS candidates"
