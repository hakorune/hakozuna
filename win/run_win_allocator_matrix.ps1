...
$Executables = @(
    ...
    @{ Name = "hz8-r3-unified-medium-record"; Path = (Join-Path $SuiteDir "bench_mixed_ws_hz8_unified_medium_record.exe"); Hz8Research = $true },
    @{ Name = "hz8-r3-owner-witness"; Path = (Join-Path $SuiteDir "bench_mixed_ws_hz8_owner_witness.exe"); Hz8Research = $true },
    @{ Name = "hz8-r3-owner-witness-diag"; Path = (Join-Path $SuiteDir "bench_mixed_ws_hz8_owner_witness_diag.exe"); Hz8Research = $true; Diagnostic = $true },
    @{ Name = "hz8-r3-page8k-range4097"; Path = (Join-Path $SuiteDir "bench_mixed_ws_hz8_medium_page8k_range4097.exe"); Hz8Research = $true },
    ...
    @{ Name = "hz8-small-partial-depot"; Path = (Join-Path $SuiteDir "bench_mixed_ws_hz8_small_partial_depot.exe"); Hz8Research = $true },
...
$AllProfiles = @(
    ...
    @{ Name = "medium_slice_4_8k_range"; Threads = 4; ItersPerThread = 120000; WorkingSet = 2048; MinSize = 4097; MaxSize = 8192; Note = "fixed medium range: 4097..8192 bytes" },
...
$Summary.Add("- `hz11-span-transfer-fine128-win` ports the complete Linux fine128 transfer policy stack with Windows FLS thread-exit salvage. It is a broad-MT opt-in row, not the selected/default Windows row.")
