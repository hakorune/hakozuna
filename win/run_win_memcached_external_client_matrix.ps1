...
$summary.Add('- `win/run_win_memcached_external_client_matrix.ps1`')
$summary.Add('- `docs/WINDOWS_BUILD.md`')
$summary.Add("")
...
foreach ($profile in $Profiles) {
    $profileOutputDir = Join-Path $RunSummaryRoot ("external_client_" + $profile.Name)
