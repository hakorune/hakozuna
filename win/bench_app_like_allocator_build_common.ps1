...
function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512CapacityFlags
    $flags += "/DHZ6_LOCAL_CACHE_TRUSTED_OWNER_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_LOCAL_CACHE_DIRECT_FREE_L1=1"
    $flags
}

function Get- {
    $flags = @()
    foreach ($flag in Get-) {
        if ($flag -like "/DHZ6_FRONT_CACHE_BIN_CAPACITY=*") {
            $flags += "/DHZ6_FRONT_CACHE_BIN_CAPACITY=((size_t)2048)"
        } else {
            $flags += $flag
        }
    }
...
function Get- {
    $flags = @()
    foreach ($flag in Get-) {
        if ($flag -like "/DHZ6_FRONT_CACHE_BIN_CAPACITY=*") {
            $flags += "/DHZ6_FRONT_CACHE_BIN_CAPACITY=((size_t)1024)"
        } else {
            $flags += $flag
        }
    }
...
function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotRunMetaDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $flags += "/DHZ6_DESCRIPTOR_DEPOT_OWNER_DIRECT_FASTPATH_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_DRAIN_DRYRUN_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotRunMetaDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $flags += "/DHZ6_DESCRIPTOR_DEPOT_OWNER_DIRECT_FASTPATH_L1=1"
    $flags += "/DHZ6_ELASTIC_SLOT_OWNER_SPARSE_META_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_SLOT_LOCALIZE_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotRunMetaDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $flags += "/DHZ6_DESCRIPTOR_DEPOT_OWNER_DIRECT_FASTPATH_L1=1"
    $flags += "/DHZ6_ELASTIC_SLOT_OWNER_SPARSE_META_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_SLOT_TRANSFER_SCOPED_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_DRYRUN_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_ROUTE_REPLACE_DRYRUN_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_FRONTCACHE_CAP_ON_FREE=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET=((size_t)2048)"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET=((size_t)512)"
    $flags += "/DHZ6_LOCAL_CACHE_TRUSTED_OWNER_L1=1"
    $flags += "/DHZ6_LOCAL_CACHE_DIRECT_FREE_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET_L1=1"
    $flags += "/DHZ6_ELASTIC_DEPOT_DESCRIPTOR_REHOME_BUDGET=((size_t)1024)"
    $flags += "/DHZ6_LOCAL_CACHE_TRUSTED_OWNER_L1=1"
    $flags += "/DHZ6_LOCAL_CACHE_DIRECT_FREE_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_LOCAL_CACHE_TRUSTED_OWNER_L1=1"
    $flags += "/DHZ6_LOCAL_CACHE_DIRECT_FREE_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_ELASTIC_DFTLC_REHOME_INTERSECTION_DRYRUN_L0=1"
    $flags
}

function Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerConsumerDryRunDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerSparseMetaDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $flags += "/DHZ6_DESCRIPTOR_DEPOT_OWNER_DIRECT_FASTPATH_L1=1"
    $flags += "/DHZ6_ELASTIC_SLOT_OWNER_CONSUMER_DRYRUN_L1=1"
    $flags
}

function Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerLogicalDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerSparseMetaDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $flags += "/DHZ6_DESCRIPTOR_DEPOT_OWNER_DIRECT_FASTPATH_L1=1"
    $flags += "/DHZ6_ELASTIC_SLOT_OWNER_LOGICAL_FASTPATH_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512CapacityFlags
    $flags += "/DHZ6_OWNER_EQUAL_CALLSITE_DRYRUN_L1=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-
    $flags += "/DHZ6_FREE_LOCAL_CACHE_OWNER_PREDICATE_DRYRUN_L0=1"
    $flags
}

function Get- {
    $flags = @()
    $flags += Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512CapacityFlags
    $flags += "/DHZ6_DEPOT_DESCRIPTOR_OWNER_EQUAL_FASTPATH_L1=1"
    $flags
}
...
function Invoke-AppLikeHz6BenchBuilds {
    ...
    if ((Split-Path -Leaf $BenchSrc) -eq "bench_allocator_compare.c") {
        $libSources += (Join-Path $RepoRoot "win\bench_allocator_compare_hz6_summary.c")
    }
    ...
    $sameOwnerTrustedFreeDescAvailNoBoostRoute4kFlags = Get-Hz6WinSameOwnerTrustedFreeDescAvailNoBoostRoute4kCapacityFlags
    ...
    $redisLowRssSourceRunDesc8kRoute8kConditionalTombCompactFlags = Get-Hz6WinRedisLowRssSourceRunDesc8kRoute8kConditionalTombCompactCapacityFlags
    ...
    $toySmallActiveMapSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinToySmallActiveMapSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $toySmallHotPathDiagSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinToySmallHotPathDiagSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorMin512DirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorMin512DirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorRange64kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorRange64kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorRange64kToyOnlyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorRange64kToyOnlyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorRange64kToyArmedDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorRange64kToyArmedDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $smallRunRouteBehaviorRange64kToyArmedSlotMax1kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSmallRunRouteBehaviorRange64kToyArmedSlotMax1kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    ...
    $sourceBlockRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteRangeIndexSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteRangeIndexSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteBehaviorDynMapNoToyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteBehaviorDynMapNoToyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $sourceBlockRouteBehaviorDynMapSmall8kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinSourceBlockRouteBehaviorDynMapSmall8kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    $directLocalFreeReuseSmall8kLargerLowRssFront8kSourceRunDesc8kRoute8kFlags = Get-Hz6WinDirectLocalFreeReuseSmall8kLargerLowRssFront8kSourceRunDesc8kRoute8kCapacityFlags
    ...
    $mixedCleanFront16kSourceRunDesc17kSource2kRoute4kLinearWrapLoopCarryFlags = Get-Hz6WinMixedCleanFront16kSourceRunDesc17kSource2kRoute4kLinearWrapLoopCarryCapacityFlags
    $mixedCleanFront16kSourceRunDesc17kSource2kRoute8kLinearWrapLoopCarryFlags = Get-Hz6WinMixedCleanFront16kSourceRunDesc17kSource2kRoute8kLinearWrapLoopCarryCapacityFlags
    $mixedCleanFront16kSourceRunDesc17kSource4kRoute8kLinearWrapLoopCarryFlags = Get-Hz6WinMixedCleanFront16kSourceRunDesc17kSource4kRoute8kLinearWrapLoopCarryCapacityFlags
    $mixedCleanFront16kSourceRunDesc17kSource2kRoute16kLinearWrapLoopCarryFlags = Get-Hz6WinMixedCleanFront16kSourceRunDesc17kSource2kRoute16kLinearWrapLoopCarryCapacityFlags
    ...
    $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectTrustedLocalCacheDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512Flags = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ = Get-
    $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerConsumerDryRunDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096Flags = Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerConsumerDryRunDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerLogicalDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096Flags = Get-Hz6WinOwnerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerLogicalDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096CapacityFlags
    $ = Get-
    $ = Get-
    $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectDepotOwnerEqualDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512Flags = Get-
    ...
    $laneMap = @{
        ...
        "sameownertrustedfree-descavail-noboost-route4k" = @{ Suffix = "_sameownertrustedfree_descavail_noboost_route4k"; ExtraFlags = $sameOwnerTrustedFreeDescAvailNoBoostRoute4kFlags }
        ...
        "redislowrss-sourcerun-desc8k-route8k-condtombcompact" = @{ Suffix = "_redislowrss_sourcerun_desc8k_route8k_condtombcompact"; ExtraFlags = $redisLowRssSourceRunDesc8kRoute8kConditionalTombCompactFlags }
        ...
        "directlocalfree-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_directlocalfree_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $directLocalFreeLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "directlocalalloc-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_directlocalalloc_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $directLocalAllocLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        ...
        "sourceblockroute-dryrun-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_dryrun_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-slotmap-dryrun-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_slotmap_dryrun_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-rangeindex-slotmap-dryrun-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_rangeindex_slotmap_dryrun_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteRangeIndexSlotMapDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-behavior-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_behavior_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-behavior-dynmap-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_behavior_dynmap_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "toysmallhotpathdiag-sourceblockroute-behavior-dynmap-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_toysmallhotpathdiag_sourceblockroute_behavior_dynmap_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $toySmallHotPathDiagSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-behavior-dynmap-notoy-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_behavior_dynmap_notoy_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteBehaviorDynMapNoToyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-dryrun-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_dryrun_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteDryRunDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-min512-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_min512_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorMin512DirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-range64k-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_range64k_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorRange64kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-range64k-toyonly-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_range64k_toyonly_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorRange64kToyOnlyDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-range64k-toyarmed-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_range64k_toyarmed_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorRange64kToyArmedDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "smallrunroute-behavior-range64k-toyarmed-slotmax1k-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_smallrunroute_behavior_range64k_toyarmed_slotmax1k_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $smallRunRouteBehaviorRange64kToyArmedSlotMax1kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "sourceblockroute-behavior-dynmap-small8k-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_sourceblockroute_behavior_dynmap_small8k_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $sourceBlockRouteBehaviorDynMapSmall8kDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "toysmallactivemap-sourceblockroute-behavior-dynmap-directlocalfreereuse-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_toysmallactivemap_sourceblockroute_behavior_dynmap_directlocalfreereuse_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $toySmallActiveMapSourceBlockRouteBehaviorDynMapDirectLocalFreeReuseLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        "directlocalfreereuse-small8k-largerlowrss-front8k-sourcerun-desc8k-route8k" = @{ Suffix = "_directlocalfreereuse_small8k_largerlowrss_front8k_sourcerun_desc8k_route8k"; ExtraFlags = $directLocalFreeReuseSmall8kLargerLowRssFront8kSourceRunDesc8kRoute8kFlags }
        ...
        "mixedclean-front16k-sourcerun-desc17k-source2k-route4k-linearwrap-loopcarry" = @{ Suffix = "_mixedclean_front16k_sourcerun_desc17k_source2k_route4k_linearwrap_loopcarry"; ExtraFlags = $mixedCleanFront16kSourceRunDesc17kSource2kRoute4kLinearWrapLoopCarryFlags }
        "mixedclean-front16k-sourcerun-desc17k-source2k-route8k-linearwrap-loopcarry" = @{ Suffix = "_mixedclean_front16k_sourcerun_desc17k_source2k_route8k_linearwrap_loopcarry"; ExtraFlags = $mixedCleanFront16kSourceRunDesc17kSource2kRoute8kLinearWrapLoopCarryFlags }
        "mixedclean-front16k-sourcerun-desc17k-source4k-route8k-linearwrap-loopcarry" = @{ Suffix = "_mixedclean_front16k_sourcerun_desc17k_source4k_route8k_linearwrap_loopcarry"; ExtraFlags = $mixedCleanFront16kSourceRunDesc17kSource4kRoute8kLinearWrapLoopCarryFlags }
        "mixedclean-front16k-sourcerun-desc17k-source2k-route16k-linearwrap-loopcarry" = @{ Suffix = "_mixedclean_front16k_sourcerun_desc17k_source2k_route16k_linearwrap_loopcarry"; ExtraFlags = $mixedCleanFront16kSourceRunDesc17kSource2kRoute16kLinearWrapLoopCarryFlags }
        ...
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-trustedlocalcache-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_depotdirect_trustedlocalcache"; ExtraFlags = $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectTrustedLocalCacheDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512Flags }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-directfree-trustedlocalcache-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_depotdirect_directfree_trustedlocalcache"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-directfree-trustedlocalcache-desc16k-front2k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_depotdirect_dftlc_front2k"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-directfree-trustedlocalcache-desc16k-front1k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_depotdirect_dftlc_front1k"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotdraindryrun-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdraindry_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotslotlocalize-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotslotlocalize_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotslottransfer-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotslottransfer_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotdescrehomedry-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdescrehomedry_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotroutereplacedry-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotroutereplacedry_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotdescrehome-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdescrehome_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotdescrehome-capfree-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdescrehome_capfree_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-depotdescrehome-budget2048-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdescrehome_budget2048_depotrunmeta_direct"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-directfree-trustedlocalcache-depotdescrehome-budget512-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdirect_dftlc_depotdescrehome_budget512"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-directfree-trustedlocalcache-depotdescrehome-budget1024-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdirect_dftlc_depotdescrehome_budget1024"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-directfree-trustedlocalcache-depotdescrehome-budget2048-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdirect_dftlc_depotdescrehome_budget2048"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotrunmeta-depotownerdirect-directfree-trustedlocalcache-depotdescrehome-budget2048-intersectiondryrun-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_depotdirect_dftlc_depotdescrehome_budget2048_interdry"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-slotownerconsumerdryrun-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_ownerloc_rss2_eldescsrcroute_slotownerconsumerdry_d16_f4_thin_nb_nrb_d192_rp_rb16_so16_osl2_fcp_sbp_s64_r16_run4096"; ExtraFlags = $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerConsumerDryRunDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096Flags }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-slotownerlogical-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run4096" = @{ Suffix = "_ownerloc_rss2_eldescsrcroute_slotownerlogical_d16_f4_thin_nb_nrb_d192_rp_rb16_so16_osl2_fcp_sbp_s64_r16_run4096"; ExtraFlags = $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowSlotOwnerLogicalDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun4096Flags }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-ownerequalcallsite-dryrun-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_ownereqsite_depotdirect"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-freelocalownerpredicate-dryrun-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_flcownerpred_depotdirect"; ExtraFlags = $ }
        "ownerlocalityfast-rsscap-2-elasticdescsource-route-depotownerdirect-depotownerequal-desc16k-front4k-thindesc-nobackptr-noroutebackptr-dir192k-routepacked-routebytes16-storageowner16-ownersourcel2-frontcachepacked-sourceblockpacked-source64-route16k-run512" = @{ Suffix = "_depotownereq_depotdirect"; ExtraFlags = $ownerLocalityFastRssCap2ElasticDescriptorSourceRouteOverflowDepotOwnerDirectDepotOwnerEqualDesc16kFront4kThinDescNoBackptrNoRouteBackptrDir192kRoutePackedBytes16StorageOwner16OwnerSourceL2FrontcachePackedSourceBlockPackedSource64Route16kRun512Flags }
