...
$LegacyExecutables = @(
    ...
    @{ Name = "hz8"; Path = (Join-Path $SuiteDir "bench_random_mixed_mt_remote_hz8.exe") },
    @{ Name = "hz8-v2-rollback"; Path = (Join-Path $SuiteDir "bench_random_mixed_mt_remote_hz8_v2.exe"); Hz8Research = $true },
