...
function Invoke-Hz8AllocatorMatrixBuild {
    ...
    foreach ($variant in @(
        ...
        @{
            ...
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_HZ10_SHADOW_L1=1",
        ...
        @{
            ...
            Output = "bench_mixed_ws_hz8_medium_page8k_target_dispatch.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1"
        ...
        @{
            Name = "hz8-r3-unified-medium-domain-shadow"
            Output = "bench_mixed_ws_hz8_unified_medium_domain_shadow.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_SHADOW_L0=1"
            )
        },
        @{
            Name = "hz8-r3-unified-medium-domain-stable"
            Output = "bench_mixed_ws_hz8_unified_medium_domain_stable.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_STABLE_RECORD_L0=1"
            )
        },
        @{
            Name = "hz8-r3-unified-page8k-record"
            Output = "bench_mixed_ws_hz8_unified_page8k_record.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1",
        ...
        @{
            Name = "hz8-r3-owner-witness"
            Output = "bench_mixed_ws_hz8_owner_witness.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_PAGE8K_RECORD_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_OWNER_WITNESS_L1=1"
            )
        },
        @{
            Name = "hz8-r3-owner-witness-diag"
            Output = "bench_mixed_ws_hz8_owner_witness_diag.exe"
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_TARGET_DISPATCH_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_PAGE8K_RECORD_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_OWNER_WITNESS_L1=1",
                "/DH8_UNIFIED_MEDIUM_DOMAIN_OWNER_WITNESS_DIAG=1"
            )
        },
        @{
            ...
            ExtraFlags = @(
                "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
                "/DH8_MEDIUM_PAGE8K_REMOTE_BEHAVIOR_L1=1",
                "/DH8_MEDIUM_PAGE8K_RANGE4097_L1=1"
            )
        },
        @{
        ...
        @{
            ...
            Output = "bench_mixed_ws_hz8_small_available4k.exe"
            ExtraFlags = @("/DH8_SMALL_AVAILABLE_INDEX_L1=1")
        },
        @{
            Name = "hz8-small-available4k-diag"
            Output = "bench_mixed_ws_hz8_small_available4k_diag.exe"
            ExtraFlags = @(
    ...
    $pageApiSmoke = Join-Path $Hz8Root "tests\h8_page8k_api_smoke.c"
    $pageApiSmokeOut = Join-Path $OutDir "h8_page8k_api_smoke.exe"
    $pageApiSmokeArgs = @(
        "/nologo", "/O2", "/DNDEBUG", "/std:c11", "/W3", "/MD",
        "/I$Hz8Root\include", "/I$Hz8Root\src",
        "/DH8_MEDIUM_PAGE8K_REMOTE_L1=1",
    ...
    $pageApiSmokeArgs += $Hz8CommonFlags
    $pageApiSmokeArgs += $Hz8Sources
    $pageApiSmokeArgs += $pageApiSmoke
    $pageApiSmokeArgs += "/Fe:$pageApiSmokeOut"
    Write-Host "[hz8-win] building h8_page8k_api_smoke.exe"
    ...
    $pageApiRangeSmokeArgs += $Hz8CommonFlags
    $pageApiRangeSmokeArgs += $Hz8Sources
    $pageApiRangeSmokeArgs += $pageApiSmoke
    $pageApiRangeSmokeArgs += "/Fe:$pageApiRangeSmokeOut"
    Write-Host "[hz8-win] building h8_page8k_api_range_smoke.exe"
    & $Compiler.Source @pageApiRangeSmokeArgs
    if ($LASTEXITCODE -ne 0) {
        throw "HZ8 page8k range API smoke build failed with exit code $LASTEXITCODE"
    }
}
