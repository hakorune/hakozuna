...
for class_id in 0 1 2 3 4 5; do
  for mode in direct active active_route active_fast active_route_probe active_range_probe active_exact_probe active_sample8 active_sample64 active_header_probe route2; do
    active_cycle=0
    active_route=0
    route_free=0
    route_interval=64
