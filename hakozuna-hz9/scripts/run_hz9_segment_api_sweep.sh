...

{
  ...
  echo "modes: bits=take/free_allocated, known_addr=slot API + address generation, active_addr=active class addr API, table_addr=debug table route, bound_addr=take_addr/free_addr"
  echo '```'
  echo
