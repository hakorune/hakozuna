...

{
  ...
  echo "modes: bits=take/free_allocated, known_addr=slot API + address generation, table_addr=debug table route, bound_addr=take_addr/free_addr"
  echo '```'
  echo
