...
OUTDIR="${OUTDIR:-${HZ9_ROOT}/bench_results/medium_fresh_process_attr_$(date -u +%Y%m%dT%H%M%SZ)}"
RUNS="${RUNS:-10}"
THREADS="${THREADS:-16}"
ITERS="${ITERS:-100000}"
LIVE_WINDOW="${LIVE_WINDOW:-4096}"
BENCH_BIN="${HZ9_ROOT}/h8_bench_release"
MATRIX_BIN="${HZ9_ROOT}/bench/out/bench_matrix_malloc"
PRELOAD_SO="${HZ9_ROOT}/libhakozuna_hz8_preload.so"
