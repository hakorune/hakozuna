...
make -C hakozuna-hz9 bench-hz9segmententry
  ...
  MODE=tlstokencachebody, MODE=tlstokencacheptrbody,
  MODE=tlstokencachesplitbody, MODE=tlstokencachetrustbody,
  MODE=tlstokencacheapi, MODE=tlstokencache, MODE=tokencacheretire,
